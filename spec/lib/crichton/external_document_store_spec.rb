  ...
  describe ExternalDocumentStore do
    ...
    describe '.store_all_external_documents' do
      ...
      it 'loads external documents' do
        ...
        files.sort.should == %w(Array.meta Array.profile DateTime.meta DateTime.profile Integer.meta
          Integer.profile Text.meta Text.profile Thing_Leviathan.meta Thing_Leviathan.profile).sort
      end
    end
  end
end
